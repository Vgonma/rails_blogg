...
# 📖 Rails Blogg <a name="about-project"></a>




**Rails Blogg** is a Ruby on Rails application that connects to a database to store and read data.
...
<details>
  ...
  <ul>
    <li><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript">Ruby on Rails</a></li>
  </ul>
</details>
...
- [Live Demo Link](https://google.com) - Comming soon
...
```cd my-folder   
    git clone git@github.com:Vgonma/rails_blogg.git
    cd rails_blogg
```
...
- **Can I contribute to the project?**
  ...
  - Yes. By all means feel free to fork the repository and make your changes.
